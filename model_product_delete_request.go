...
type _ProductDeleteRequest ProductDeleteRequest
...
func (o *ProductDeleteRequest) &#39;Has&#39;Product() bool {
	if o != nil && !IsNil(o.Product) {
		return true
	}
...
func (o *ProductDeleteRequest) UnmarshalJSON(data []byte) (err error) {
	varProductDeleteRequest := _ProductDeleteRequest{}

	err = json.Unmarshal(data, &varProductDeleteRequest)

	if err != nil {
		return err
	}

	*o = ProductDeleteRequest(varProductDeleteRequest)
...
func (o *ProductDeleteRequest) GetValue() interface{} {
...
func (o *ProductDeleteRequest) SetValue(value interface{}) {
